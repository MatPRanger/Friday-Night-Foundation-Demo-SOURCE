...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['gunlmao', "Value 1: takes away health lmao and describes how much health to take lmaooo"],
		['healthset', "Value 1: it sets how much health you have dumbass"],
		['meeffect', 'dont use this outside of the song me'],
		['myworldeffect', 'dont use this outside of the song my-world'],
		['dodgemechanic', 'used in captivated']
	];
